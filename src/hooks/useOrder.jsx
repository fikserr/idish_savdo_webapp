...
function normalizeProduct(item, counts = {}, fallbackStock = { id: '', name: 'Asosiy sklad' }) {
  ...
  // Submitting USD-only products in their native currency never got 1C to report them
  // under "Jami. val" (tried per-line currency, saleType, an order-level currency field,
  // and computed paymentSum/paymentVal — see basket.jsx) — so this always uses the
  // UZS-converted display price/currency instead, same as everywhere else in the app.
